...
export class PtyOwnershipTransferDestinationFileStore implements PtyOwnershipTransferDestinationStore {
  ...
  private readonly input: PtyOwnershipTransferDestinationInputFileStore
  private readonly replay: PtyOwnershipTransferDestinationReplayFileStore
  private readonly surface: PtyOwnershipTransferDestinationSurfaceFileStore
  ...
  prepare(
    ...
    requireSequence(acceptedSourceEndSeq)
    ...
    this.persist(identity, this.newRecord(journal))
