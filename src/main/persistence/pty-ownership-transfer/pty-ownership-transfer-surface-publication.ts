...
export type PtyOwnershipTransferDurableSurfaceTarget = Readonly<{
  ...
  publishDurably: (request: PtyOwnershipTransferDestinationPublicationRequest) => void
}>
...
export class PtyOwnershipTransferSurfacePublicationCoordinator {
  constructor(private readonly target: PtyOwnershipTransferDurableSurfaceTarget) {}
...
function framesReachCommit(request: PtyOwnershipTransferDestinationPublicationRequest): boolean {
