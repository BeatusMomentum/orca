...
describe('orcad migration cutover coordinator', () => {
  ...
  it('recovers a lost stage response from durable destination status', async () => {
  ...
  it('reconciles a lost abort response to absent before releasing the source', async () => {
    const store = createStoreDouble()
    const remote = remoteOperations()
