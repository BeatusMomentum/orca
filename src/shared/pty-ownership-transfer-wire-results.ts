...
export function parsePtyOwnershipTransferPrepareResult(
  ...
  return Object.freeze({
    ...
    ...(record.surfacePublication === undefined
      ? {}
      : {
...
export function parsePtyOwnershipTransferStatusResult(
  ...
  if (
    ...
    reconnectGeneration < identity.sourceOwnerGeneration
  ) {
...
function parseOutputFrame(value: unknown): PtyOwnershipTransferOutputFrame {
  const record = requireRecord(value)
  if (
